...
window.CONTENT = {
  ...
  currency:              "MAD",
  priceFrom:             "5,500",   // base board price (all white, standard glass)
  colourTintCharge:      200,       // added per coloured area (deck / bottom / rails)
  glassingStandardCharge:0,
  glassingStrongCharge:  200,
  glassingHeavyCharge:   400,
  ...
  testiQuote:   "For nearly a decade, I rode the same 7'0" midlength in everything from knee-high waves to double overhead. I've always been a one-board-quiver surfer. I want a board I can trust in almost any conditions, never sitting out the back wishing I'd brought something else. When I finally decided it was time for a change, I spent almost a year testing boards from a range of respected shapers and brands before finding the right one. The Bilt 6'10" Double Double was the board that stood out. It paddles effortlessly, catches just about everything, feels incredibly fast, and still turns with precision. More than anything, it made me want to surf more, train harder, and keep improving. My surfing has progressed more in the past months than it had in years. After 25 years in the water, that's not something I expected. This board brought back the feeling of being in my early twenties again, and it's become the best surfboard I've ever ridden.",
  ...
  faqs: [
    ...
    { q: "Can I really choose any colour?",
      a: "You can. Deck, bottom, and rails are each fully customisable — pick a swatch or any colour you like. A plain white board is standard; each area you colour adds 200 MAD." },
...
/* ============================================================
   PHOTOS — replace files in /images (keep the same names):
     ...
     images/coach-dris.jpg           (your photo — testimonial)
